...
$$
\text{Interference}_{ij} = \beta_0 + \beta_{\text{Trait}} \times \text{Trait}_i + \epsilon_{ij}
$$

**Model 2: Main effects model**
$$
\text{Interference}_{ij} = \beta_0 + \beta_{\text{Trait}} \times \text{Trait}_i + \beta_{\text{Group}} \times \text{Group}_i + \beta_{\text{Prev}} \times \text{Prev}_{ij} + \epsilon_{ij}
$$
